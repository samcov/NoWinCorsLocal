        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            app.Map("/echo", a => a.Run(c =>
            {
                ...
                accept(
                    ...
                    async wsEnv =>
                    {
                        //var responseHeaders = wsEnv.Get<IDictionary<string, string[]>>("owin.ResponseHeaders");
                        //responseHeaders.Add("Access-Control-Allow-Origin", new[] { "*" });
            ...
            app.Run(c =>
                {
                    //c.Response.Headers.Add("Access-Control-Allow-Origin", new[] { "*" });
